...
and (EXISTS (select 1 from ljagetendorse where   grpcontno =a.grpcontno and feeoperationtype in ('CT','NI') and makedate=DATE_SUB('${data_date}',INTERVAL 1 day) )
or (a.state='30' and a.enddate=DATE_SUB('${data_date}',INTERVAL 1 day))
